...
static PerfmonGroupMap interlagos_group_map[NUM_GROUPS_INTERLAGOS] = {
    ...
    {"CACHE",CACHE,0,"Data cache miss rate/ratio","RETIRED_INSTRUCTIONS:PMC0,DATA_CACHE_ACCESSES:PMC1,DATA_CACHE_REFILLS_VALID:PMC2,DATA_CACHE_MISSES_ALL:PMC3"},
    ...
    {"L2",L2,0,"L2 cache bandwidth in MBytes/s","DATA_CACHE_REFILLS_ALL:PMC0,DATA_CACHE_REFILLS_SYSTEM:PMC1,CPU_CLOCKS_UNHALTED:PMC2"},

    {"L2CACHE",L2CACHE,0,"L2 cache miss rate/ratio","RETIRED_INSTRUCTIONS:PMC0,REQUESTS_TO_L2_DC_FILL:PMC1,L2_CACHE_MISS_DC_FILL:PMC2"},

    {"L3",L3,0,"L3 cache bandwidth in MBytes/s","L2_FILL_WB_FILL:PMC0,L2_FILL_WB_WB:PMC1,CPU_CLOCKS_UNHALTED:PMC2"},

    {"L3CACHE",L3CACHE,0,"L3 cache miss rate/ratio","RETIRED_INSTRUCTIONS:PMC0,UNC_READ_REQ_TO_L3_ALL:UPMC0,UNC_L3_CACHE_MISS_ALL:UPMC1,UNC_L3_LATENCY_CYCLE_COUNT:UPMC2,UNC_L3_LATENCY_REQUEST_COUNT:UPMC3"},

    {"LINKS",LINKS,0,"Bandwidth on the Hypertransport links","UNC_LINK_TRANSMIT_BW_L0_USE:UPMC0,UNC_LINK_TRANSMIT_BW_L1_USE:UPMC1,UNC_LINK_TRANSMIT_BW_L2_USE:UPMC2,UNC_LINK_TRANSMIT_BW_L3_USE:UPMC3"},

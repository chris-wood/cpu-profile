...
static PerfmonGroupMap atom_group_map[NUM_GROUPS_ATOM] = {
    ...
    {"DATA",DATA,0,"Load to store ratio","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,L1D_CACHE_LD:PMC0,L1D_CACHE_ST:PMC1"},
    ...
    {"FLOPS_X87",FLOPS_X87,0,"X87 MFlops/s","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,X87_COMP_OPS_EXE_ANY_AR:PMC0"},
    ...
    {"TLB",TLB,0,"TLB miss rate","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,DATA_TLB_MISSES_DTLB_MISS:PMC0"},

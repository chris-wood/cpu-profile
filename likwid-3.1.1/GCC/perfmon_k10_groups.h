...
static PerfmonGroupMap k10_group_map[NUM_GROUPS_K10] = {
    ...
    {"BRANCH",BRANCH,0,"Branch prediction miss rate/ratio","INSTRUCTIONS_RETIRED:PMC0,BRANCH_RETIRED:PMC1,BRANCH_MISPREDICT_RETIRED:PMC2,BRANCH_TAKEN_RETIRED:PMC3"},

    {"CACHE",CACHE,0,"Data cache miss rate/ratio","INSTRUCTIONS_RETIRED:PMC0,DATA_CACHE_ACCESSES:PMC1,DATA_CACHE_REFILLS_L2_ALL:PMC2,DATA_CACHE_REFILLS_NORTHBRIDGE_ALL:PMC3"},

    {"CPI",CPI,0,"Cycles per instruction","INSTRUCTIONS_RETIRED:PMC0,CPU_CLOCKS_UNHALTED:PMC1,UOPS_RETIRED:PMC2"},

    {"FLOPS_DP",FLOPS_DP,0,"Double Precision MFlops/s","SSE_RETIRED_ADD_DOUBLE_FLOPS:PMC0,SSE_RETIRED_MULT_DOUBLE_FLOPS:PMC1,CPU_CLOCKS_UNHALTED:PMC2"},

    {"FLOPS_SP",FLOPS_SP,0,"Single Precision MFlops/s","SSE_RETIRED_ADD_SINGLE_FLOPS:PMC0,SSE_RETIRED_MULT_SINGLE_FLOPS:PMC1,CPU_CLOCKS_UNHALTED:PMC2"},

    {"FLOPS_X87",FLOPS_X87,0,"X87 MFlops/s","X87_FLOPS_RETIRED_ADD:PMC0,X87_FLOPS_RETIRED_MULT:PMC1,X87_FLOPS_RETIRED_DIV:PMC2,CPU_CLOCKS_UNHALTED:PMC3"},

    {"FPU_EXCEPTION",FPU_EXCEPTION,0,"Floating point exceptions","INSTRUCTIONS_RETIRED:PMC0,FP_INSTRUCTIONS_RETIRED_ALL:PMC1,FPU_EXCEPTIONS_ALL:PMC2"},

    {"ICACHE",ICACHE,0,"Instruction cache miss rate/ratio","INSTRUCTIONS_RETIRED:PMC0,ICACHE_FETCHES:PMC1,ICACHE_REFILLS_L2:PMC2,ICACHE_REFILLS_MEM:PMC3"},

    {"L2",L2,0,"L2 cache bandwidth in MBytes/s","DATA_CACHE_REFILLS_L2_ALL:PMC0,DATA_CACHE_EVICTED_ALL:PMC1,CPU_CLOCKS_UNHALTED:PMC2"},

    {"L2CACHE",L2CACHE,0,"L2 cache miss rate/ratio","INSTRUCTIONS_RETIRED:PMC0,L2_REQUESTS_ALL:PMC1,L2_MISSES_ALL:PMC2,L2_FILL_ALL:PMC3"},

    {"L3CACHE",L3CACHE,0,"L3 cache miss rate/ratio","INSTRUCTIONS_RETIRED:PMC0,L3_READ_REQUEST_ALL_ALL_CORES:PMC1,L3_MISSES_ALL_ALL_CORES:PMC2"},

    {"MEM",MEM,0,"Main memory bandwidth in MBytes/s","NORTHBRIDGE_READ_RESPONSE_ALL:PMC0,OCTWORDS_WRITE_TRANSFERS:PMC1,DRAM_ACCESSES_DCTO_ALL:PMC2,DRAM_ACCESSES_DCT1_ALL:PMC3"},

    {"NUMA",NUMA,0,"Bandwidth on the Hypertransport links","CPU_TO_DRAM_LOCAL_TO_0:PMC0,CPU_TO_DRAM_LOCAL_TO_1:PMC1,CPU_TO_DRAM_LOCAL_TO_2:PMC2,CPU_TO_DRAM_LOCAL_TO_3:PMC3"},

    {"NUMA2",NUMA2,0,"Bandwidth on the Hypertransport links","CPU_TO_DRAM_LOCAL_TO_4:PMC0,CPU_TO_DRAM_LOCAL_TO_5:PMC1,CPU_TO_DRAM_LOCAL_TO_6:PMC2,CPU_TO_DRAM_LOCAL_TO_7:PMC3"},

    {"TLB",TLB,0,"TLB miss rate/ratio","INSTRUCTIONS_RETIRED:PMC0,DATA_CACHE_ACCESSES:PMC1,DTLB_L2_HIT_ALL:PMC2,DTLB_L2_MISS_ALL:PMC3"},

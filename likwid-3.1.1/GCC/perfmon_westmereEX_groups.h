...
perfmon_printDerivedMetricsWestmereEX(PerfmonGroup group)
{
    ...
    switch ( group ) 
    {
        ...
        case MEM:
            ...
            bstrListAdd(fc,9,Remote write data traffic Port 0 [MBytes/s]);

            bstrListAdd(fc,10,Remote write data traffic Port 1 [MBytes/s]);

            bstrListAdd(fc,11,Remote write data traffic Port 4 [MBytes/s]);

            bstrListAdd(fc,12,Remote write data traffic Port 5 [MBytes/s]);

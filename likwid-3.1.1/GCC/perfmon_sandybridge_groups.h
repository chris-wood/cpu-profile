...
#define NUM_GROUPS_SANDYBRIDGE 13
...
static PerfmonGroupMap sandybridge_group_map[NUM_GROUPS_SANDYBRIDGE] = {
    ...
    {"ENERGY",ENERGY,0,"Power and Energy consumption","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,PWR_PKG_ENERGY:PWR0,PWR_DRAM_ENERGY:PWR3"},

    {"FLOPS_AVX",FLOPS_AVX,0,"Packed AVX MFlops/s","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,FP_256_PACKED_SINGLE:PMC0,FP_256_PACKED_DOUBLE:PMC1"},
    ...
    {"FLOPS_SP",FLOPS_SP,0,"Single Precision MFlops/s","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,FP_COMP_OPS_EXE_SSE_FP_PACKED_SINGLE:PMC0,FP_COMP_OPS_EXE_SSE_FP_SCALAR_SINGLE:PMC1,FP_256_PACKED_SINGLE:PMC2"},
    ...
    {"MEM_DP",MEM_DP,1,"Overview of arithmetic and main memory performance","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,FP_COMP_OPS_EXE_SSE_FP_PACKED_DOUBLE:PMC0,FP_COMP_OPS_EXE_SSE_FP_SCALAR_DOUBLE:PMC1,SIMD_FP_256_PACKED_DOUBLE:PMC2,CAS_COUNT_RD:MBOX0C0,CAS_COUNT_WR:MBOX1C0,CAS_COUNT_RD:MBOX0C1,CAS_COUNT_WR:MBOX1C1,CAS_COUNT_RD:MBOX0C2,CAS_COUNT_WR:MBOX1C2,CAS_COUNT_RD:MBOX0C3,CAS_COUNT_WR:MBOX1C3"},

    {"MEM_SP",MEM_SP,1,"Overview of arithmetic and main memory performance","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,FP_COMP_OPS_EXE_SSE_FP_PACKED_SINGLE:PMC0,FP_COMP_OPS_EXE_SSE_FP_SCALAR_SINGLE:PMC1,SIMD_FP_256_PACKED_DOUBLE:PMC2,CAS_COUNT_RD:MBOX0C0,CAS_COUNT_WR:MBOX1C0,CAS_COUNT_RD:MBOX0C1,CAS_COUNT_WR:MBOX1C1,CAS_COUNT_RD:MBOX0C2,CAS_COUNT_WR:MBOX1C2,CAS_COUNT_RD:MBOX0C3,CAS_COUNT_WR:MBOX1C3"},
...
perfmon_printDerivedMetricsSandybridge(PerfmonGroup group)
{
    ...
    switch ( group ) 
    {
        ...
        case ENERGY:
            ...
            bstrListAdd(fc,6,Energy DRAM [J]);
        ...
        case FLOPS_AVX:
            ...
            bstrListAdd(fc,5,32b packed SP MFlops/s);

            bstrListAdd(fc,6,32b packed DP MFlops/s);
        ...
        case MEM_DP:
            ...
            bstrListAdd(fc,9,Memory Read BW [MBytes/s]);

            bstrListAdd(fc,10,Memory Write BW [MBytes/s]);

            bstrListAdd(fc,11,Memory BW [MBytes/s]);
...
perfmon_logDerivedMetricsSandybridge(PerfmonGroup group, double time,double timeStamp)
{
    ...
    switch ( group ) 
    {
        ...
        case FLOPS_AVX:
                        ...
                        printf("32b packed SP MFlops/s %e ",timeStamp);
                        for(threadId=0; threadId < perfmon_numThreads; threadId++)
                        {
                            tmpValue = 1.0E-06*(perfmon_getResult(threadId,"PMC0")*8.0)/time;
                            if (!isnan(tmpValue))
                        ...
                        printf("32b packed DP MFlops/s %e ",timeStamp);
                        for(threadId=0; threadId < perfmon_numThreads; threadId++)
                        {
                            tmpValue = 1.0E-06*(perfmon_getResult(threadId,"PMC1")*4.0)/time;
                            if (!isnan(tmpValue))

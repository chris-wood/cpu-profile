...
#define NUM_GROUPS_IVYBRIDGE 13
...
static PerfmonGroupMap ivybridge_group_map[NUM_GROUPS_IVYBRIDGE] = {
    ...
    {"ENERGY",ENERGY,0,"Power and Energy consumption","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,TEMP_CORE:TMP0,PWR_PKG_ENERGY:PWR0,PWR_DRAM_ENERGY:PWR3"},

    {"FLOPS_AVX",FLOPS_AVX,0,"Packed AVX MFlops/s","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,SIMD_FP_256_PACKED_SINGLE:PMC0,SIMD_FP_256_PACKED_DOUBLE:PMC1"},

    {"FLOPS_DP",FLOPS_DP,0,"Double Precision MFlops/s","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,FP_COMP_OPS_EXE_SSE_FP_PACKED_DOUBLE:PMC0,FP_COMP_OPS_EXE_SSE_FP_SCALAR_DOUBLE:PMC1,SIMD_FP_256_PACKED_DOUBLE:PMC2"},

    {"FLOPS_SP",FLOPS_SP,0,"Single Precision MFlops/s","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,FP_COMP_OPS_EXE_SSE_FP_PACKED_SINGLE:PMC0,FP_COMP_OPS_EXE_SSE_FP_SCALAR_SINGLE:PMC1,SIMD_FP_256_PACKED_SINGLE:PMC2"},

    {"L2",L2,0,"L2 cache bandwidth in MBytes/s","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,L1D_REPLACEMENT:PMC0,L1D_M_EVICT:PMC1"},
    ...
    {"L3",L3,0,"L3 cache bandwidth in MBytes/s","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,L2_LINES_IN_ALL:PMC0,L2_LINES_OUT_DIRTY_ALL:PMC1"},

    {"MEM",MEM,1,"Main memory bandwidth in MBytes/s","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,CAS_COUNT_RD:MBOX0C0,CAS_COUNT_WR:MBOX1C0,CAS_COUNT_RD:MBOX0C1,CAS_COUNT_WR:MBOX1C1,CAS_COUNT_RD:MBOX0C2,CAS_COUNT_WR:MBOX1C2,CAS_COUNT_RD:MBOX0C3,CAS_COUNT_WR:MBOX1C3"},

    {"MEM_DP",MEM_DP,1,"Power and Energy consumption","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,PWR_PKG_ENERGY:PWR0,PWR_DRAM_ENERGY:PWR3,FP_COMP_OPS_EXE_SSE_FP_PACKED_DOUBLE:PMC0,FP_COMP_OPS_EXE_SSE_FP_SCALAR_DOUBLE:PMC1,SIMD_FP_256_PACKED_DOUBLE:PMC2,CAS_COUNT_RD:MBOX0C0,CAS_COUNT_WR:MBOX1C0,CAS_COUNT_RD:MBOX0C1,CAS_COUNT_WR:MBOX1C1,CAS_COUNT_RD:MBOX0C2,CAS_COUNT_WR:MBOX1C2,CAS_COUNT_RD:MBOX0C3,CAS_COUNT_WR:MBOX1C3"},

    {"MEM_SP",MEM_SP,1,"Power and Energy consumption","INSTR_RETIRED_ANY:FIXC0,CPU_CLK_UNHALTED_CORE:FIXC1,CPU_CLK_UNHALTED_REF:FIXC2,PWR_PKG_ENERGY:PWR0,PWR_DRAM_ENERGY:PWR3,FP_COMP_OPS_EXE_SSE_FP_PACKED_SINGLE:PMC0,FP_COMP_OPS_EXE_SSE_FP_SCALAR_SINGLE:PMC1,SIMD_FP_256_PACKED_SINGLE:PMC2,CAS_COUNT_RD:MBOX0C0,CAS_COUNT_WR:MBOX1C0,CAS_COUNT_RD:MBOX0C1,CAS_COUNT_WR:MBOX1C1,CAS_COUNT_RD:MBOX0C2,CAS_COUNT_WR:MBOX1C2,CAS_COUNT_RD:MBOX0C3,CAS_COUNT_WR:MBOX1C3"},
...
perfmon_printDerivedMetricsIvybridge(PerfmonGroup group)
{
    ...
    switch ( group ) 
    {
        ...
        case ENERGY:
            ...
            bstrListAdd(fc,5,TEMP [C]);

            bstrListAdd(fc,6,Energy [J]);

            bstrListAdd(fc,7,Power [W]);

            bstrListAdd(fc,8,Energy DRAM [J]);

            bstrListAdd(fc,9,Power DRAM [W]);
            ...
            for(threadId=0; threadId < perfmon_numThreads; threadId++)
            {
                ...
                tmpValue = perfmon_getResult(threadId,"TMP0");
                if (!isnan(tmpValue))
                {
                    tableData.rows[4].value[threadId] = tmpValue;
                }
                ...
                tmpValue = perfmon_getResult(threadId,"PWR3");
                if (!isnan(tmpValue))
                {
                    tableData.rows[7].value[threadId] = tmpValue;
                }
                ...
                tmpValue = perfmon_getResult(threadId,"PWR3")/time;
                if (!isnan(tmpValue))
                {
        ...
        case FLOPS_AVX:
            ...
            bstrListAdd(fc,5,SP 32b packed MFlops/s);

            bstrListAdd(fc,6,DP 32b packed MFlops/s);
        ...
        case FLOPS_DP:
            ...
            for(threadId=0; threadId < perfmon_numThreads; threadId++)
            {
                ...
                tmpValue = 1.0E-06*(perfmon_getResult(threadId,"PMC0")+perfmon_getResult(threadId,"PMC2"))/time;
                if (!isnan(tmpValue))
                {
                    tableData.rows[6].value[threadId] = tmpValue;
                }
        ...
        case FLOPS_SP:
            ...
            bstrListAdd(fc,6,32b AVX MFlops/s);
            ...
            for(threadId=0; threadId < perfmon_numThreads; threadId++)
            {
                ...
                tmpValue = 1.0E-06*(perfmon_getResult(threadId,"PMC2")*8.0)/time;
                if (!isnan(tmpValue))
                {
                    tableData.rows[5].value[threadId] = tmpValue;
                }
        ...
        case MEM_DP:
            ...
            bstrListAdd(fc,7,Energy DRAM [J]);

            bstrListAdd(fc,8,Power DRAM [W]);

            bstrListAdd(fc,9,AVX MFlops/s);

            bstrListAdd(fc,10,MFlops/s);

            bstrListAdd(fc,11,Packed MUOPS/s);

            bstrListAdd(fc,12,Scalar MUOPS/s);

            bstrListAdd(fc,13,Memory Read BW [MBytes/s]);

            bstrListAdd(fc,14,Memory Write BW [MBytes/s]);

            bstrListAdd(fc,15,Memory BW [MBytes/s]);

            bstrListAdd(fc,16,Memory data volume [GBytes]);
            ...
            for(threadId=0; threadId < perfmon_numThreads; threadId++)
            {
                ...
                tmpValue = 1.0E-06*(4.0*perfmon_getResult(threadId,"PMC2"))/time;
                if (!isnan(tmpValue))
                {
                    tableData.rows[8].value[threadId] = tmpValue;
                }
                ...
                if (!isnan(tmpValue))
                {
                    tableData.rows[15].value[threadId] = tmpValue;
                }
                else
                {
                    tableData.rows[15].value[threadId] = 0.0;
                }

                stat[15][0] += (double) tableData.rows[15].value[threadId];

                stat[15][1] =  MAX(stat[15][1],(double) tableData.rows[15].value[threadId]);
                stat[15][2] =  MIN(stat[15][2],(double) tableData.rows[15].value[threadId]);
        ...
        case MEM_SP:
            ...
            for(threadId=0; threadId < perfmon_numThreads; threadId++)
            {
                ...
                tmpValue = 1.0E-06*(8.0*perfmon_getResult(threadId,"PMC2"))/time;
                if (!isnan(tmpValue))
                {
                    tableData.rows[8].value[threadId] = tmpValue;
                }
...
perfmon_logDerivedMetricsIvybridge(PerfmonGroup group, double time,double timeStamp)
{
    ...
    switch ( group ) 
    {
        ...
        case ENERGY:
                        ...
                        printf("Energy DRAM [J] %e ",timeStamp);
                        for(threadId=0; threadId < perfmon_numThreads; threadId++)
                        {
                            tmpValue = perfmon_getResult(threadId,"PWR3");
                            if (!isnan(tmpValue))
                        ...
                        printf("Power DRAM [W] %e ",timeStamp);
                        for(threadId=0; threadId < perfmon_numThreads; threadId++)
                        {
                            tmpValue = perfmon_getResult(threadId,"PWR3")/time;
                            if (!isnan(tmpValue))
        ...
        case FLOPS_AVX:
                        ...
                        printf("SP 32b packed MFlops/s %e ",timeStamp);
                        for(threadId=0; threadId < perfmon_numThreads; threadId++)
                        {
                            tmpValue = 1.0E-06*(perfmon_getResult(threadId,"PMC0")*8.0)/time;
                            if (!isnan(tmpValue))
                        ...
                        printf("DP 32b packed MFlops/s %e ",timeStamp);
                        for(threadId=0; threadId < perfmon_numThreads; threadId++)
                        {
                            tmpValue = 1.0E-06*(perfmon_getResult(threadId,"PMC1")*4.0)/time;
                            if (!isnan(tmpValue))
        ...
        case FLOPS_DP:
                        ...
                        printf("AVX MFlops/s %e ",timeStamp);
                        for(threadId=0; threadId < perfmon_numThreads; threadId++)
                        {
                            tmpValue = 1.0E-06*(perfmon_getResult(threadId,"PMC2")*4.0)/time;
                            if (!isnan(tmpValue))
        ...
        case FLOPS_SP:
                        ...
                        printf("32b AVX MFlops/s %e ",timeStamp);
                        for(threadId=0; threadId < perfmon_numThreads; threadId++)
                        {
                            tmpValue = 1.0E-06*(perfmon_getResult(threadId,"PMC2")*8.0)/time;
                            if (!isnan(tmpValue))
...
"},
    ...
    {"MEM","Profiling group to measure main memory bandwidth drawn by all cores of\n\
